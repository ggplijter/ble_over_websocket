...
class CustomBleakClientWinRT(BaseBleakClient):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        super(CustomBleakClientWinRT, self).__init__(address_or_ble_device, **kwargs)
    ...
    async def get_services(
        ...
        **kwargs,
        ...
        Returns:
           A :py:class:`custom_bleak.backends.service.BleakGATTServiceCollection` with this device's services tree.
